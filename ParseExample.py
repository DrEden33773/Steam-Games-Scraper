...
for app in dataset:
    ...
    scoreRank = game[
        "score_rank"
    ]  # Score rank of the game based on user reviews (string).
    achievements = game[
        "achievements"
